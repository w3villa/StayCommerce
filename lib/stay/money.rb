...
module Stay
  class Money
    ...
    def initialize(amount, options = {})
      ...
      @money   = Monetize.parse([amount, (options[:currency] || Stay::Store.default.default_currency)].join)
      @options = Stay::Money.default_formatting_rules.merge(options)
    end
    ...
    def use_default_currency
      currency = Stay::Store.default.default_currency
