module Stay
  module Admin
    module BaseHelper
      ...
      def stay_humanize_dropdown_values(model_name, options = {})
      ...
      def link_to_icon_remove_fields(form)
        ...
        link_to_with_icon('delete.svg', '', url,
                          class: 'remove_fields btn btn-sm btn-danger',
                          data: {
                            action: 'remove'
                          },
                          title: I18n.t(:remove),
      ...
      #   button_link_to("Preview #{resource_name}", storefront_resource_url(resource), class: 'btn-light', icon: 'view.svg', id: "adminPreview#{resource_name}",        
      ...
      #   Stay::Config[:taxon_wysiwyg_editor_enabled]
      # end
