...
module Stay
  module Seeds
    class States
      ...
      def self.call
        Stay::Country.where(states_required: true).each do |country|
      ...
      def self.state_level(country, subregion)
      ...
      def self.province_level(country, subregion)
        ...
        Stay::State.insert_all(new_states)
      end
    end
  end
end
