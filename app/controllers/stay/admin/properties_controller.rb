    ...
    class PropertiesController < Stay::Admin::BaseController
      ...
      def property_params
        params.require(:property).permit(
          :active, :title, :description, :availability_start, :availability_end, :address,
          :user_id, :price_per_night, :property_category_id, :guest_number, :country_id, :state_id,
          :bedroom_description, :university_nearby, :about_neighbourhoods, :instant_booking,
          :minimum_days_of_booking, :security_deposit, :extra_guest, :allow_extra_guest, :city, :total_bedrooms,
          :latitude, :longitude, :total_rooms, :total_bathrooms, :property_size, :cover_image, :zipcode,amenity_ids: [],
